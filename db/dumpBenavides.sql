...
CREATE TABLE public.addresses (
    ...
    street_number_norm character varying NOT NULL,
...
-- Name: meds_synoynms; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.meds_synoynms (
    synonym text NOT NULL,
    med_id uuid
);


ALTER TABLE public.meds_synoynms OWNER TO postgres;
...
COPY public.family_history (id, clinical_history_id, relationship_type, condition_code_id, condition_code, condition_system, condition_display, relative_age_of_consent, relative_is_deceased, note, verfication_status, recorded_at, recorded_by, updated_at, updated_by) FROM stdin;
\.
...
-- Dependencies: 234
-- Data for Name: meds_synoynms; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.meds_synoynms (synonym, med_id) FROM stdin;
\.
...
COPY public.patient_allergies (id, clinical_history_id, substance_code_id, substance_code, substance_system, substance_display, reaction, severity, criticality, status, first_onset, last_ocurrance, note, recorded_at, recorded_by, updated_at, updated_by) FROM stdin;
\.
...
COPY public.patient_conditions (id, clinical_history_id, code_id, code, code_system, code_display, onset_date, abatement_date, verification_status, note, recorded_at, recorded_by, updated_at, updated_by) FROM stdin;
\.
...
COPY public.patient_medications (id, clinical_history_id, medication_code_id, medication_code, medication_system, medication_display, dose, route, frequency, start_date, end_date, medication_status, prescriber_id, source, note, recorded_at, recorded_by, updated_at, updated_by) FROM stdin;
\.
...
COPY public.patient_procedures (id, clinical_history_id, procedure_code_id, procedure_code, procedure_system, procedure_display, performed_on, facility, note, recorded_at, recorded_by, updated_at, updated_by) FROM stdin;
\.
...
ALTER TABLE ONLY public.addresses
    ADD CONSTRAINT addresses_unique UNIQUE (street_number, street_name_norm);
...
--
-- TOC entry 5044 (class 2606 OID 16876)
-- Name: addresses addresses_unique_2; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.addresses
    ADD CONSTRAINT addresses_unique_2 UNIQUE (id_neighborhood);
...
-- Name: meds_synoynms meds_synoynms_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.meds_synoynms
    ADD CONSTRAINT meds_synoynms_pk PRIMARY KEY (synonym);
...
ALTER TABLE ONLY public.audit_logs
    ADD CONSTRAINT audit_logs_users_fk FOREIGN KEY (id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.clinical_histories
    ADD CONSTRAINT clinical_histories_patients_fk FOREIGN KEY (id) REFERENCES public.patients(id);
...
-- Name: meds_synoynms meds_synoynms_meds_dictionary_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.meds_synoynms
    ADD CONSTRAINT meds_synoynms_meds_dictionary_fk FOREIGN KEY (med_id) REFERENCES public.meds_dictionary(id);
...
ALTER TABLE ONLY public.patient_alerts
    ADD CONSTRAINT patient_alerts_users_fk FOREIGN KEY (id) REFERENCES public.users(id);
